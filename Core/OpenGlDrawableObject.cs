...
public abstract class OpenGlDrawableObject : IDrawable
{
    ...
    private readonly ShaderHandler _shaders = new(SharedConfigs.VertexShaderFilePath, SharedConfigs.FragmentShaderFilePath);
    ...
    public OpenGlDrawableObject(Vector3[] vertices, uint[] indices, Vector3? centerOfMass = null, Vector3? position = null, Color4? color = null)
    {
        ...
        _vertices = vertices;
        _indices = indices;
        _centerOfMass = centerOfMass ?? SharedConfigs.DefaultOriginPosition;
        _position = position ?? _centerOfMass;
        _color = color ?? SharedConfigs.DefaultColor;
    }
    ...
    public void Build(Vector3? initialPosition = null)
    {
        ...
        _shaders.Use();
        _shaders.SetUniformVector4(SharedConfigs.ColorUniformName, ((Vector4)_color));
    }
    ...
    public void Draw(Matrix4 viewProjectionMatrix)
    {
        ...
        _shaders.Use();
        _shaders.SetUniformMatrix4(SharedConfigs.MvpMatrixUniformName, _mvpMatrix);
